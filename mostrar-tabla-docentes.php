...
// Datos combinados de usuario y perfil docente para la tabla administrativa.
$sql = "SELECT
    u.id AS usuario_id,
    d.id AS docente_id,
    u.nombre, 
    ...
    WHERE u.rol_id = 3"; // rol_id 3: docente.

$resultado = mysqli_query($conexion, $sql);

// Muestra la tabla solo cuando existen docentes registrados.
