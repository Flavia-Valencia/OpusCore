                ...
                <div class="modal-grid">
                    ...
                    <div class="modal-campo">
                        ...
                        <div class="input-password">
                            <input type="text" name="password_hash" id="edita-password_hash"
                                autocomplete="off"
                                style="-webkit-text-security: disc;"
                                data-modal="true">
                            <!-- Ícono de ojo para mostrar u ocultar la contraseña -->
                            <span class="ver-contrasena-admin" style="display:none;" onclick="toggleContrasena('edita-password_hash', 'icono-ojo-admin')">
