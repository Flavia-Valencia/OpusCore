    ...
    <header class="header">
      ...
      <input type="checkbox" id="menu-toggle" class="menu-checkbox">
        ...
        <nav class="nav">
            ...
            <a href="/OpusCore/Admin/admin-inicio.php" class="btn-nav">Inicio</a>
            <a href="/OpusCore/Admin/admin-periodos.php" class="btn-nav">Periodos</a>
            <a href="/OpusCore/Admin/admin-estudiantes.php" class="btn-nav active">Estudiantes</a>
            <a href="/OpusCore/Admin/admin-cursos.php" class="btn-nav">Cursos</a>
            <a href="/OpusCore/Admin/admin-docentes.php" class="btn-nav">Docentes</a>
            <a href="/OpusCore/Admin/admin-pagos.php" class="btn-nav">Pagos</a>
            <a href="/OpusCore/Admin/admin-facturacion.php" class="btn-nav">Facturación</a>
            <a href="/OpusCore/Admin/admin-plazo.php" class="btn-nav">Plazo Notas</a>
    ...
    <main class="main">
        ...
        <div class="card">
            ...
            <div class="tabla-placeholder">
                <?php include('../api/tablas/mostrar-tabla-estudiantes.php'); ?>
