   ...
   <!-- encabezado con logo, menú hamburguesa para móvil y navegación principal -->
    <header class="header">
        ...
        <nav class="nav">
            ...
            <a href="/OpusCore/Admin/admin-estudiantes.php" class="btn-nav">Estudiantes</a>
            <a href="/OpusCore/Admin/admin-cursos.php" class="btn-nav">Cursos</a>
            <a href="/OpusCore/Admin/admin-docentes.php" class="btn-nav active">Docentes</a>
    ...
    <main class="main">
        ...
        <div class="card">
            ...
            <div class="tabla-placeholder">
                <?php include('../api/tablas/mostrar-tabla-docentes.php'); ?>
